...
const Template: ComponentStory<typeof Tabs> = args => (
  <>
    <Tabs {...args}>
      ...
      <Tabs.Panel value="2" label="Tab 2">Panel 2</Tabs.Panel>
      <Tabs.Panel value="3" label="Tab 3">Panel 3</Tabs.Panel>
      <Tabs.Panel value="4" label="Tab 4">Panel 4</Tabs.Panel>
...
export const DisabledTabs: ComponentStory<typeof Tabs> = args => (
  <Tabs defaultValue="1" {...args}>
    ...
    <Tabs.Panel value="2" label="Tab 2">Panel 2</Tabs.Panel>
    <Tabs.Panel value="3" label="Tab 3">Panel 3</Tabs.Panel>
    <Tabs.Panel disabled value="4" label="Tab 4">Panel 4</Tabs.Panel>
    <Tabs.Panel value="5" label="Tab 5">Panel 5</Tabs.Panel>
    <Tabs.Panel value="6" label="Tab 6">Panel 6</Tabs.Panel>
  </Tabs>
);
